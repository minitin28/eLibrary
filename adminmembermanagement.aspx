               ...
               <div class="card-body">
                  ...
                  <div class="row">
                      ...
                      <div class="col-md-3">
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                 <asp:TextBox CssClass="form-control" ID="TextBox1" runat="server" placeholder="MID"></asp:TextBox>
                      ...
                      <div class="col-md-5">
                        ...
                        <div class="form-group">
                             <div class="input-group">
                                <asp:TextBox CssClass="form-control mr-1" ID="TextBox8" runat="server" placeholder="Account Status" ReadOnly="True" Width="16px"></asp:TextBox>
                   ...
                   <div class="row">
                       ...
                       <div class="col-md-3">
                        <label>DOB</label>
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="TextBox7" runat="server" placeholder="Date Of Birth" ReadOnly="True"></asp:TextBox>
                        </div>
                     </div>
