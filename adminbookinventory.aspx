                  ...
                  <div class="row">
                   ...
                   <div class="row">
                       ...
                       <div class="col-md-4">
                        ...
                        <div class="form-group">
                            <asp:DropDownList CssClass="form-control" ID="DropDownList1" runat="server">
                                ...
                                <asp:ListItem Text="Herbew" Value="Herbew" />
                                <asp:ListItem Text="English-UK" Value="English-UK" />
                            </asp:DropDownList>
                        </div>
                      ...
                      <div class="col-md-4">
                        ...
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="TextBox3" runat="server" placeholder="Published Date"></asp:TextBox>
                       ...
                       <div class="col-md-4">
                        ...
                        <div class="form-group">
                            <asp:ListBox CssClass="form-control" ID="ListBox1" runat="server" SelectionMode="Multiple" Rows="4">
                                ...
                                <asp:ListItem Text="Prog" Value="A1" />
                                <asp:ListItem Text="Prog" Value="A2" />
                                <asp:ListItem Text="Networking" Value="A3" />
                                <asp:ListItem Text="Puzzles" Value="A4" />
                                <asp:ListItem Text="Quants" Value="A5" />
                                <asp:ListItem Text="Fiction" Value="A6" />
                   ...
                   <div class="row">
                      ...
                      <div class="col-md-4">
                       ...
                       <div class="col-md-4">
                        ...
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="TextBox7" runat="server" placeholder="issued Books" TextMode="Number"></asp:TextBox>
                        </div>
                     </div>
                   ...
                   <div class="row">
                       <div class="col-12">
                        ...
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="TextBox6" runat="server" placeholder="Book Discription" TextMode="MultiLine" Rows="2"></asp:TextBox>
                        </div>
                     </div>
