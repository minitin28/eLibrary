<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="adminpublishermanagement.aspx.cs" Inherits="WebApplication1.WebForm2" %>
                  ...
                  <div class="row">
                     <div class="col-md-4">
                        ...
                        <div class="form-group">
                           ...
                           <asp:TextBox CssClass="form-control" ID="TextBox1" runat="server" placeholder="PID"></asp:TextBox>
